...
class AgencyService extends ServiceBase {
    private readonly defaultUrl = this.apiUrlDomain + 'api/agencies';
    ...
    getTiles() {
        return this.http.get<any>(this.companyTilesUrl).toPromise();
    }
